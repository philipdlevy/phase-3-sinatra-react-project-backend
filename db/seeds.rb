...
harry_potter_and_the_sorcerers_stone = Book.create(title: "Harry Potter and the Sorcerer's Stone", description: "Fantasy Novel", price: 25.99, pages: 200, author_id: jk_rowling.id)

the_shining = Book.create(title: "The Shining", description: "Horror Novel", price: 20.00, pages: 300, author_id: stephen_king.id)

along_came_a_spider = Book.create(title: "Along Came a Spider", description: "Thriller Novel", price: 27.99, pages: 330, author_id: james_patterson.id)

a_time_to_kill = Book.create(title: "A Time To Kill", description: "Legal Thriller Novel", price: 30.99, pages: 400, author_id: john_grisham.id)

adventures_of_huckleberry_finn = Book.create(title: "Adventures of Huckleberry Finn", description: "Huckleberry Finn's escape from his abusive father", price: 21.00, pages: 290, author_id: mark_twain.id)

the_old_man_and_the_sea = Book.create(title: "The Old Man and The Sea", description: "Old Man Battles Fish", price: 11.39, pages: 130, author_id: ernest_hemingway.id)

great_expectations = Book.create(title: "Great Expectation", description: "Learn to lower expectations", price: 4.99, pages: 530, author_id: charles_dickens.id)
